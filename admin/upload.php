...
if (!empty($_POST)): 
  ...
  if($_POST['highlight'] == 1):
   ...
   array(':hi'=>1));
    ...
    $_SESSION['messages']['success'][]='Votre vidéo a bien été modifiée'; 
    else:
    $_SESSION['messages']['success'][]='Votre vidéo a bien été ajoutée'; 
    endif; 
    ...
    <fieldset class="uploadfield">
       ...
       <!-- nom -->
        <div class="upload-group">
            ...
            <input type="text" name="name" value="<?= $upload['name'] ?? "" ; ?>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Put the film title">
        </div>
        
        <!-- description -->
        <div class="upload-group">
            <label for="exampleTextarea" class="form-label mt-4">Resume</label>
            <textarea name="description" class="form-control" id="exampleTextarea" rows="3" placeholder="Put a quick resume"><?= $upload['description'] ?? "" ; ?></textarea>
        </div>
        ...
        <div class="upload-group">
            <div class="d-flex align-items-center justify-content-around">
                <label for="exampleTextarea" class="form-label mt-4">Highlight :</label>
        ...
        <button type="submit" class="btn btn-primary btn-success">Upload / Modify</button>
        <br>
    </fieldset>
</form>
